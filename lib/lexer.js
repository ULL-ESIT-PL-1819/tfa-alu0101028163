...
const KEYWORDS = ["CONST","VAR","PROCEDURE","CALL","BEGIN","END","IF","THEN","WHILE","DO","PRINT", "OBJECT", "EXTENDS"];
...
// console.log(ins(tokenize_program_from_file("../examples/object_declaration_3.pl")))
