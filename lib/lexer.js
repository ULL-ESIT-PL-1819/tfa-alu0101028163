...
const KEYWORDS = ["CONST","VAR","PROCEDURE","CALL","BEGIN","END","IF","THEN","WHILE","DO","PRINT", "CLASS", "EXTENDS", "NEW"];
...
// console.log(ins(tokenize_program_from_file("../examples/pl0_1.pl")))
// console.log(ins(tokenize_program("a := new Betha();")));
